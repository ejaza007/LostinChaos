...
Zombie::Zombie(float x, float y, SDL_Renderer* renderer, Map* map, Object* player, vector<Object*>* objects, SoundManager* sm)
	: Enemy (x, y, renderer, map, player, objects, ZOMBIE_PNG, ZOMBIE_TAG, sm) {
...
void Zombie::fire(vector<Object*>& list, vector<Object*>& bullets, std::array<Tile*, MAP_LENGTH>& map, double deltaTime) {
